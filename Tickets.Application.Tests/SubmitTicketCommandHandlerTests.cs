...
{
    public class SubmitTicketCommandHandlerTests
    {
        [Fact]
        public async Task Throws_when_ticket_does_not_exist()
        {
            ...
            var handler = new SubmitTicketCommandHandler(
            repository,
            unitOfWork);
            var command = new SubmitTicketCommand(commandId);
        ...
        [Fact]
        public async Task Commits_when_ticket_is_submited()
        {
            //Arrange
